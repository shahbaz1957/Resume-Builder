...
function Login() {
  ...
  const urlState = searchParam.get("state")
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-linear-to-r from-green-50 via-green-200 to-green-50">
      
      <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-green-50 shadow-lg">
